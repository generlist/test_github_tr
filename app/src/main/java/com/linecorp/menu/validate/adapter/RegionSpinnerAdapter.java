...
public class RegionSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {
    ...
    private List<StaticMenuMeta.RegionItem> mDataList;

    public RegionSpinnerAdapter(Context context, List<StaticMenuMeta.RegionItem> mDataList) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        StaticMenuMeta.RegionItem services = mDataList.get(position);
