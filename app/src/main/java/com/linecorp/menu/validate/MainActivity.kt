...
class MainActivity : AppCompatActivity(), AdapterView.OnItemSelectedListener,
    ...
    private var menuParameterItem: MenuParameterItem? = MenuParameterItem("en","iphone","id")
...
//                                ).show()
        ...
        btnPlay!!.setOnClickListener { view: View ->
            ...
            if (view.getTag() != null && TextUtils.isEmpty(versionCode)==false ) {
               val memuParameterItem =  view?.getTag() as (MenuParameterItem)
                ...
                val requestUrl =String.format(menuUrl,memuParameterItem.languageCode,memuParameterItem.device,memuParameterItem.region,versionCode)
    ...
    override fun onItemSelected(parent: AdapterView<*>, view: View, position: Int, id: Long) {
        ...
        Log.d(TAG,"select memuParameterItem language ${menuParameterItem?.languageCode} device ${menuParameterItem?.device} region ${menuParameterItem?.region} version :  ${version?.text.toString()}");
    ...
    companion object {
        ...
        private val TAG = "@@MainActivity"
        private val menuUrl = "http://appresources.beta.line.naver.jp/moretab/list.json?lang=%s&device=%s&region=%s&v=%s"
    }
