...
public class ServerTypeSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {

    private Context mContext= null;
    private List<StaticMenuMeta.ServerTypeItem> mDataList;

    public ServerTypeSpinnerAdapter(Context context, List<StaticMenuMeta.ServerTypeItem> mDataList) {
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        StaticMenuMeta.ServerTypeItem services = mDataList.get(position);

        holderVideoItem.textViewItemName.setText(services.serverType);
