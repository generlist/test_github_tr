...
public class CategoryExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    HashMap<Integer,ArrayList<Integer>> childMap;
    private JsonModelList<DataModel> dataModel;
    private String deviceType;
    private HashMap<Integer,Integer> headerHashMap;

    public CategoryExpandableListAdapter(Context context, HashMap<Integer,Integer> headerHashMap , HashMap<Integer,ArrayList<Integer>> childMap , JsonModelList<DataModel> dataModel, String deviceType) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        int parentId = (Integer)getGroup(groupPosition);
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        if(groupNmae !=null){
            groupNmae.setText(String.format("parentId : %s",parentId));
        }
        return convertView;
    }
